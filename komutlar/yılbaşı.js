...
exports.run = async (client, message, args) => {
    ...
    if (gn.getMonth() == 0 && gn.getDate() == 1) {
        ...
        var t = sayac(son);
        message.channel.send(new Discord.MessageEmbed().setColor('#fffa00').setDescription(`Gün: ${t.gun}, Saat: ${t.saat}, Dakika: ${t.dakika}, Saniye: ${t.saniye}`))
        if(t.total<=0){
            message.channel.send(new Discord.MessageEmbed().setColor('#fffa00').setDescription(`Mutlu Yıllar.`)) 
        }
