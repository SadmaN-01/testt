...
if(!args[0]) return message.channel.send(emb.setDescription(`Bir argüman girmelisin: **${prefix}sağ-tık-kick aç/kapat**`))
...
message.channel.send(emb.setDescription(`Sistem aktif edildi: Sağ tık kick atmaya çalışanların yetkisini alacağım. Şimdi İse **${prefix}sağ-tık-kick ayarla #kanal** Yazınız`)) }
...
exports.conf = {
  enabled: true,
  guildOnly: false,
  aliases: ['sağ-tık-kick-koruması'],
  permLevel: 0
};

exports.help = {
  name: 'sağ-tık-kick-koruması'
};